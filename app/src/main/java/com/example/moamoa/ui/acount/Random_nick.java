...
public class Random_nick {
    ArrayList<String> nickarray = new ArrayList<String>(Arrays.asList("무지개","분홍","오렌지","개나리","연두","해변의","퍼렁","하얀"));
    ArrayList<String> chararray = new ArrayList<String>(Arrays.asList("곰돌이","귀긴곰","꽥","웨옹","고양이","곰","토끼","오리","고양이"));

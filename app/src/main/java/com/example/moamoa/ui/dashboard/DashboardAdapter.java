...
public class DashboardAdapter extends RecyclerView.Adapter<DashboardAdapter.Holder> {
    ...
    private List<com.example.moamoa.ui.dashboard.DashboardData> list = new ArrayList<>();

    public DashboardAdapter(Context context, List<com.example.moamoa.ui.dashboard.DashboardData> list){
